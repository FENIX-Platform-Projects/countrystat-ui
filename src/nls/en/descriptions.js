...
define(function () {
    ...
    return {
        ...
        "root": "Basic Metadata",
        "uid": "Resource identifier. It is a code that creates the match between the resource and the metadata it is associated to.",
        "title": "Textual label used as title of the resource.",
        "creationDate": "Creation date of the resource.",
        "characterSet": "Full name of the character coding standard used by the resource.",
        ...
        "metadataStandardName": "Name of the metadata standard specifications used. In FENIX framework this field would be pre-compiled by 'FENIX'.",
        ...
        "noDataValue": " Value assigned to the cells to represent the absence of data. Missing values are usually highlight through apposite ags, however the data matrix does not report empty cells but a predefined combination of characters (such as 'NA', '000' . . . ) indicating the absence of data.",
        ...
        "meStatisticalProcessing.seSecondaryDataCollection.originOfCollectedData": "Coded element which allows to specify in a standard way the origin of the resource.",
        ...
        "meStatisticalProcessing.seSecondaryDataCollection.organization": "If the element \u003c\u003coriginOfCollectedData\u003e\u003e has been generally specified as \u0027other International Organizations\u0027 this element requests to report the exact source of the resource.",
        "meStatisticalProcessing.seSecondaryDataCollection.dataCollection": "Data collection details.",
