...
define(function () {
    ...
    return {
        ...
        "uid": "Identificateur de ressource. Il s'agit d'un code qui crée la correspondance entre la ressource et les métadonnées auxquelles elle est associée.",
        "title": "Etiquette textuelle utilisée comme titre de la ressource.",
        "creationDate": "Date de création de la ressource.",
        "characterSet": "Nom complet de la norme de codage de caractères utilisée par la ressource.",
        "language": "Langue utilisée par la ressource pour les informations textuelles.",
        "languageDetails": "Commentaires et détails supplémentaires sur la langue utilisés pour les informations textuelles de la ressource. Ce champ est addressé à mettre en évidence des incohérences particulières dans la langue (ou langues) utilisée(s) dans la ressource, le cas échéant. Par exemple pour avertir que la ressource n'est pas complètement homogène dans la langue utilisée pour les informations textuelles. Sinon, il peut être laissé vide.",
        "metadataStandardName": "Nom des spécifications standard des métadonnées utilisées. Dans le cadre de FENIX ce champ serait pré-compilé par 'FENIX'.",
        "metadataStandardVersion": "Version des spécifications standards de métadonnées utilisée.",
        "metadataLanguage": "Langue(s) utilisée(s) pour les métadonnées",
        "noDataValue": "Valeur assignée aux cellules pour représenter l'absence de données. Les valeurs manquantes sont généralement mises en évidence par des étiquettes appropriées (tels que \'NA\', \'000\')",
        ...
        "meStatisticalProcessing.seSecondaryDataCollection.organization": "Si l'élément origine des données collectées a généralement été spécifié comme étant d'autres organisations internationales, cet élément demande de rapporter la source exacte de la ressource.",
        "meStatisticalProcessing.seSecondaryDataCollection.dataCollection": "Détails de la collecte des données.",
