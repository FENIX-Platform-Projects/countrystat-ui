...
define(function () {
    ...
    return {
        ...
        "uid": "Code d'identification de la ressource",
        "title": "Titre",
        "creationDate" : "Date de Création",
        "characterSet": "Jeu de caractères",
        "language": "Langue(s)",
        "languageDetails": "Détails sur la langue",
        "metadataStandardName": "Norme de métadonnées utilisée",
        "metadataStandardVersion": "Version des normes des métadonnées",
        "metadataLanguage": "Langue des métadonnées",
        "noDataValue": "Valeur assignée Value assigned au manque de donnée",
        ...
        "meStatisticalProcessing.seSecondaryDataCollection": "Collecte de données secondaires",
        "meStatisticalProcessing.seSecondaryDataCollection.originOfCollectedData": "Origine des données collectées",
        "meStatisticalProcessing.seSecondaryDataCollection.rawDataDescription": "Description des données brutes",
        "meStatisticalProcessing.seSecondaryDataCollection.organization": "Organisation",
        "meStatisticalProcessing.seSecondaryDataCollection.dataCollection": "Collecte de données",
